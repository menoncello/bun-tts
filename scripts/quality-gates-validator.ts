...
import { runQualityGatesValidation, handleValidatorError } from './quality-gates-executor';
import type { QualityGateResult, ValidationResult } from './quality-gates-types';

// Re-export types for backward compatibility
export type { QualityGateResult, ValidationResult };
